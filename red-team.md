...
**Historia:** partí de un script de 49 entradas y lo llevé a la v3.0.0 de septiembre de 2026, con 104 referencias, CLI de consulta y suite de 14 pruebas.
...
**Historia:** lo creé en 2023 como mi cuaderno de resoluciones; no todo el material es de mi autoría, su fin es documentativo.
...
**Hito:** llegué al top 100 del ranking de Atenea (CCN-CERT), plataforma española de retos. Retiré las soluciones voluntariamente por respeto a las normas de la plataforma (no publicar soluciones, solo pequeñas pistas).
...
**Historia:** lo mantengo activo desde 2018.
...
**Historia:** empecé esta recolección en 2016, de la época clásica del reversing en Windows.
...
**Historia:** años de práctica continua en la plataforma, complementando mi reversing con pentesting aplicado.
...
**Historia:** lo diseñé y programé yo, mezclando juego, web y seguridad.
...
**Historia:** lo creé en 2024 para conservar mis máquinas de práctica.
